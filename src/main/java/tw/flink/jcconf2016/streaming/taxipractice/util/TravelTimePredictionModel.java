 ...
 */
package tw.flink.jcconf2016.streaming.taxipractice.util;
 ...
 * on the distance.
 *
 * NOTE: This model is not meant for accurate predictions but rather to illustrate Flink's handling
 * of operator state.
 */
public class TravelTimePredictionModel {
	...
	private SimpleRegression[] models;
