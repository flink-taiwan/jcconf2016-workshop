 ...
 * with some minor modifications specifically for this workshop.
 * --------------------------------------------------------------------------
 */
public class TaxiRideWithKafkaAnswer {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<TaxiRide> ridesFromKafka = env.addSource(consumer);
